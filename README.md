...
3. The general steps you took that led you to that error/problem.
4. The settings that you have set in FrameGUI.
...
### Dependencies
FrameGUI depends on multiple other thrid party applications in order for it to function. A list of each application is below along with a copy of their license, the author, and the source code. By using FrameGUI, you also agree to the terms and conditions of the licenses of those applications.
