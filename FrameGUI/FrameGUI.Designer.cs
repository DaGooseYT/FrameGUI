...
namespace FrameGUI
{
    public partial class FrameGUI : Form
    {
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(FrameGUI));
            this.EncodePB = new ProgressBar();
            this.SaveOutTxtBox = new TextBox();
            this.SaveOutBttn = new Button();
            this.StartEncodeBttn = new Button();
            this.AboutTab = new TabPage();
            this.AboutAuthGB = new GroupBox();
            this.TwitterLogo = new PictureBox();
            this.InstagramLogo = new PictureBox();
            this.YoutubeLogo = new PictureBox();
            this.AboutAuthDesc = new Label();
            this.AbAuthorLabel = new Label();
            this.AboutAuthLabel = new Label();
            this.AboutGUIGB = new GroupBox();
            this.AboutGUIDesc = new Label();
            this.AbGUILabel = new Label();
            this.AboutGUILabel = new Label();
            this.MainTab = new TabPage();
            this.CancelBttn = new Button();
            this.FrameGUILabel = new Label();
            this.FrameGUILogo = new PictureBox();
            this.SetInputBttn = new Button();
            this.InTxtBox = new TextBox();
            this.Tabs = new TabControl();
            this.SettingsTab = new TabPage();
            this.SettingsTabs = new TabControl();
            this.VideoTab = new TabPage();
            this.SizeGB = new GroupBox();
            this.ResizeAlgoDD = new ComboBox();
            this.ResizeAlgoLabel = new Label();
            this.WidthResNUD = new NumericUpDown();
            this.WidthLabel = new Label();
            this.HeightResNUD = new NumericUpDown();
            this.VidHeightLebel = new Label();
            this.ChangeResCB = new CheckBox();
            this.SizeLabel = new Label();
            this.EncodeGB = new GroupBox();
            this.ColorsGB = new GroupBox();
            this.SharpenValNUD = new NumericUpDown();
            this.SharpenCB = new CheckBox();
            this.ColorsDD = new ComboBox();
            this.ColorsLabel = new Label();
            this.FrameGB = new GroupBox();
            this.FrameLabel = new Label();
            this.FRLabel = new Label();
            this.FrameRNUD = new NumericUpDown();
            this.bframeLabel = new Label();
            this.BframeValue = new NumericUpDown();
            this.ModeGB = new GroupBox();
            this.crfNUD = new NumericUpDown();
            this.crfValueLabel = new Label();
            this.EModeSettingLabel = new Label();
            this.BitrateValue = new NumericUpDown();
            this.BitrateLabel = new Label();
            this.UseCB2 = new CheckBox();
            this.TuneDD = new ComboBox();
            this.TuneLabel = new Label();
            this.EncodeModeDD = new ComboBox();
            this.EncodeModeLabel = new Label();
            this.CPUPDD = new ComboBox();
            this.CPUPreLabel = new Label();
            this.EncodeLabel = new Label();
            this.AudioTab = new TabPage();
            this.AudioSetGB = new GroupBox();
            this.SRDD = new ComboBox();
            this.AudNote = new Label();
            this.AudioSRLabel = new Label();
            this.AudioBitLabel = new Label();
            this.AudBitrateDD = new ComboBox();
            this.AudioSetLabel = new Label();
            this.AudFormatLabel = new Label();
            this.AudFormatDD = new ComboBox();
            this.ScriptOtherTab = new TabPage();
            this.vsSettingLabel = new GroupBox();
            this.MaxMemLabel = new Label();
            this.MaxMemNUD = new NumericUpDown();
            this.ThreadsNUD = new NumericUpDown();
            this.ThreadsLabel = new Label();
            this.aviLabel = new Label();
            this.OtherSettingGB = new GroupBox();
            this.NotificationCB = new CheckBox();
            this.CopyCommandBttn = new Button();
            this.SaveSettingBttn = new Button();
            this.OtherSettingLabel = new Label();
            this.SettingsGB = new GroupBox();
            this.ArtefactLabel = new Label();
            this.UseGPUCB = new CheckBox();
            this.IwantDD = new ComboBox();
            this.IwantLabel = new Label();
            this.OutFPSNUD = new NumericUpDown();
            this.OutFPSLabel = new Label();
            this.InputFPSNUD = new NumericUpDown();
            this.InputFPSLabel = new Label();
            this.NoobCB = new CheckBox();
            this.UseCB = new CheckBox();
            this.StuckLink = new LinkLabel();
            this.StuckLabel = new Label();
            this.AnalyseTxtBox = new TextBox();
            this.AnalyseLabel = new Label();
            this.SuperTxtBox = new TextBox();
            this.SmoothTxtBox = new TextBox();
            this.SuperLabel = new Label();
            this.SmoothLabel = new Label();
            this.ScriptsLabel = new Label();
            this.FormatDD = new ComboBox();
            this.FFWorker = new BackgroundWorker();
            this.ProgressLabel = new Label();
            this.VideoLinkEN = new LinkLabel();
            this.AboutTab.SuspendLayout();
            this.AboutAuthGB.SuspendLayout();
            ((ISupportInitialize)(this.TwitterLogo)).BeginInit();
            ((ISupportInitialize)(this.InstagramLogo)).BeginInit();
            ((ISupportInitialize)(this.YoutubeLogo)).BeginInit();
            this.AboutGUIGB.SuspendLayout();
            this.MainTab.SuspendLayout();
            ((ISupportInitialize)(this.FrameGUILogo)).BeginInit();
            this.Tabs.SuspendLayout();
            this.SettingsTab.SuspendLayout();
            this.SettingsTabs.SuspendLayout();
            this.VideoTab.SuspendLayout();
            this.SizeGB.SuspendLayout();
            ((ISupportInitialize)(this.WidthResNUD)).BeginInit();
            ((ISupportInitialize)(this.HeightResNUD)).BeginInit();
            this.EncodeGB.SuspendLayout();
            this.ColorsGB.SuspendLayout();
            ((ISupportInitialize)(this.SharpenValNUD)).BeginInit();
            this.FrameGB.SuspendLayout();
            ((ISupportInitialize)(this.FrameRNUD)).BeginInit();
            ((ISupportInitialize)(this.BframeValue)).BeginInit();
            this.ModeGB.SuspendLayout();
            ((ISupportInitialize)(this.crfNUD)).BeginInit();
            ((ISupportInitialize)(this.BitrateValue)).BeginInit();
            ...
            ((ISupportInitialize)(this.MaxMemNUD)).BeginInit();
            ((ISupportInitialize)(this.ThreadsNUD)).BeginInit();
            this.OtherSettingGB.SuspendLayout();
            this.SettingsGB.SuspendLayout();
            ((ISupportInitialize)(this.OutFPSNUD)).BeginInit();
            ((ISupportInitialize)(this.InputFPSNUD)).BeginInit();
            this.SuspendLayout();
            // 
            // EncodePB
            // 
            ...
            this.StartEncodeBttn.TabIndex = 3;
            ...
            this.AboutTab.Padding = new Padding(3);
            ...
            this.AboutAuthGB.Size = new System.Drawing.Size(217, 213);
            ...
            this.TwitterLogo.Location = new System.Drawing.Point(151, 149);
            this.TwitterLogo.Margin = new Padding(4);
            ...
            this.InstagramLogo.Location = new System.Drawing.Point(7, 149);
            this.InstagramLogo.Margin = new Padding(4);
            ...
            this.YoutubeLogo.Location = new System.Drawing.Point(78, 153);
            this.YoutubeLogo.Margin = new Padding(4);
            ...
            this.AboutAuthDesc.Font = new System.Drawing.Font("Arial", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.AboutAuthDesc.Location = new System.Drawing.Point(16, 30);
            this.AboutAuthDesc.Margin = new Padding(4, 0, 4, 0);
    ...
    "s \r\nbelow (click one):";
            ...
            this.AboutGUIDesc.Font = new System.Drawing.Font("Arial", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.AboutGUIDesc.Location = new System.Drawing.Point(17, 30);
            this.AboutGUIDesc.Margin = new Padding(4, 0, 4, 0);
            ...
            this.VideoTab.Padding = new Padding(3);
            ...
            this.AudioTab.Padding = new Padding(3);
    ...
    ".";
            ...
            this.vsSettingLabel.TabIndex = 5;
            ...
            this.OtherSettingGB.TabIndex = 4;
            ...
            // CopyCommandBttn
            // 
            this.CopyCommandBttn.Location = new System.Drawing.Point(6, 18);
            this.CopyCommandBttn.Name = "CopyCommandBttn";
            this.CopyCommandBttn.Size = new System.Drawing.Size(147, 25);
            this.CopyCommandBttn.TabIndex = 2;
            ...
            // SaveSettingBttn
            // 
            this.SaveSettingBttn.Location = new System.Drawing.Point(159, 18);
            this.SaveSettingBttn.Name = "SaveSettingBttn";
            this.SaveSettingBttn.Size = new System.Drawing.Size(133, 25);
            this.SaveSettingBttn.TabIndex = 1;
            ...
            this.StuckLink.LinkClicked += new LinkLabelLinkClickedEventHandler(this.StuckLink_LinkClicked);
            // 
            // StuckLabel
            // 
            ...
            ((ISupportInitialize)(this.TwitterLogo)).EndInit();
            ((ISupportInitialize)(this.InstagramLogo)).EndInit();
            ((ISupportInitialize)(this.YoutubeLogo)).EndInit();
            this.AboutGUIGB.ResumeLayout(false);
            this.AboutGUIGB.PerformLayout();
            this.MainTab.ResumeLayout(false);
            this.MainTab.PerformLayout();
            ((ISupportInitialize)(this.FrameGUILogo)).EndInit();
            ...
            ((ISupportInitialize)(this.WidthResNUD)).EndInit();
            ((ISupportInitialize)(this.HeightResNUD)).EndInit();
            this.EncodeGB.ResumeLayout(false);
            this.EncodeGB.PerformLayout();
            this.ColorsGB.ResumeLayout(false);
            this.ColorsGB.PerformLayout();
            ((ISupportInitialize)(this.SharpenValNUD)).EndInit();
            this.FrameGB.ResumeLayout(false);
            this.FrameGB.PerformLayout();
            ((ISupportInitialize)(this.FrameRNUD)).EndInit();
            ((ISupportInitialize)(this.BframeValue)).EndInit();
            this.ModeGB.ResumeLayout(false);
            this.ModeGB.PerformLayout();
            ((ISupportInitialize)(this.crfNUD)).EndInit();
            ((ISupportInitialize)(this.BitrateValue)).EndInit();
            ...
            ((ISupportInitialize)(this.MaxMemNUD)).EndInit();
            ((ISupportInitialize)(this.ThreadsNUD)).EndInit();
            ...
            ((ISupportInitialize)(this.OutFPSNUD)).EndInit();
            ((ISupportInitialize)(this.InputFPSNUD)).EndInit();
